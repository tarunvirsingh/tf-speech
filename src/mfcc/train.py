...
from lib import create_estimator, model_dir, POSSIBLE_LABELS, params, id2name, FINGERPRINT_KEY
...
def data_generator_fn(meta_list, bg_params, mode=None):
    def generator():
        ...
        for (label, fname) in meta_list:
            ...
            result = dict();
            result[FINGERPRINT_KEY]=featureGenerator.getFeatures(filename=fname, fg_vol=fg_vol, bg_vol=bg_vol)
